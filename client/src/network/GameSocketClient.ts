...
export class GameSocketClient {
  ...
  connect(): void {
    ...
    const invalidateHome = (): void => this.callbacks.onHomeStateChanged?.();
    socket.on(socketEvents.homeFurniturePlace, invalidateHome);
    socket.on(socketEvents.homeFurnitureMove, invalidateHome);
