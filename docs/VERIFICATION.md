...
- Verified HEAD: `2e0e9896cf6e64b902f2f2e19b626e11682625e2`
- GitHub Actions run: `35412228703`
- Result: **SUCCESS**
...
The Playwright gate boots the real client and server, uses documented local development auth, enters solo Amaya Bay through the player-facing onboarding flow, waits for the game engine to become playable, checks for browser runtime errors, confirms the renderer/debug frame is alive, and samples the rendered canvas to reject an empty/flat frame.
